                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role_id" id="role_id" class="form-select select2" required>
                                            ...
                                            @foreach ($roles as $item)
                                                <option {{(Request::get('role') ?? $data->role->name) == $item->name ? 'selected=selected':''}} data-url='{{route('user.edit',['id'=>$data->id,'role'=>$item->name])}}' value="{{$item->id}}" >{{$item->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
