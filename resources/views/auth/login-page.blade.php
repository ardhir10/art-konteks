                    ...
                    <div class="d-flex flex-column min-vh-100 px-3 pt-4">
                        <div class="row justify-content-center my-auto">
                            <div class="col-md-8 col-lg-6 col-xl-8">
                                <div class="text-center pd-1 py-5" style="padding: 22px;margin-top: 100px;">


                                    <div class="mb-2 mb-md-3">
                                        <a href="{{route('dashboard')}}" class="d-block auth-logo"
                                            style="padding: 10px 41px">
                                            <img src="{{asset('images/logo-konteks.png')}}" height="170px" alt=""
                                    ...
                                    <form action="{{ route('login') }}" method="post">
                                        ...
                                        <div class="mt-3">
                                            <button class="btn  w-50 btn-konteks shadow-xl fs-5 fw-bold" style="border-radius:10px;padding:10px" type="submit">Masuk</button>
                                        </div>
                                    </form><!-- end form -->

                                    <div class="mt-5 text-center text-white">
                                        <p>Don't have an account ? <a href="{{route('register')}}" class="fw-medium "> Register </a></p>
                                    </div>
                                </div>
                            </div><!-- end col -->
                        </div><!-- end row -->
