                        ...
                        <div class="card-body p-4">
                            <p class=" mb-0">
                                ...
                                <div class=" row mt-2">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label class="mb-0" for="">KSOP Penerbit Dokumen</label>
                                            <span class="fw-bolder d-block">{{$tindakLanjut->dataPenerbit->nama ?? null}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-lg-12">
                                        <h5 class="">Rekomendasi KSOP :</h5>
                                        <table class="table  table-sm table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{asset('dokumen-rekom-pertek/rekomendasi-ksop/'.$tindakLanjut->file_name)}}"  target="_blank">
