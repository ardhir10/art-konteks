                        ...
                        <div class="form-group mb-2 row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <a href="{{asset('/dokumen-permohonan/rekomendasi-teknis/ppsbnp/sp/'.$data->surat_permohonan)}}"
                                            target="_blank">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <a href="{{asset('/dokumen-permohonan/rekomendasi-teknis/ppsbnp/pl/'.$data->peta_laut)}}"
                                                target="_blank">
                                                <button class="btn btn-sm btn-success">Download</button>
                                            </a>
                                        </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <a href="{{asset('/dokumen-permohonan/rekomendasi-teknis/ppsbnp/rkk/'.$data->rencana_kunjungan_kapal)}}"
                                                target="_blank">
                                                <button class="btn btn-sm btn-success">Download</button>
                                            </a>
                                        </div>
