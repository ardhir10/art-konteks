...
@if ($data->prosesPermohonan->last()->tindak_lanjut ?? null == 'Draft Rekom/Pertek')
    @if ($data->prosesPermohonan->last()->type != 'LAPORAN RAPAT')
        <div>
                        ...
                        <div class="col-12">
                            <form action="{{route('approval-survey.tindak-lanjut',$data->id)}}" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-6">
                                        <div class="form-check mb-2">
                                            <input class="form-check-input" type="radio" id="ditolak" value="Ditolak" onchange="tindakLanjut('Ditolak')"
                                            name="tindak_lanjut">
