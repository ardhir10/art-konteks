                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                        ...
                                        onclick='showPolygon(@json($data->lokasiTerminalKhusus),"polygonMaps","Lokasi Terminal Khusus")'>LIHAT
                                        PETA</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                        data-bs-target="#polygonMaps"
                                        onclick='showPolygon(@json($data->lokasiTerminalKhususRencanaAreaLabuh),"polygonMaps","Lokasi Rencana Area Labuh")'>LIHAT
                                        PETA</button>
                                </div>
                            </div>
                        </div>
