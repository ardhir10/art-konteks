...
<div class="row animate__animated  animate__fadeIn">
    <div class="col-lg-12">
        <div class="card shadow-lg">
            ...
            <form id="formPermohonan" action="{{route('permohonan.rekomendasi-teknis.penyelenggara-alur-pelayaran.store')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body row">
                    <div class="col-6">
                        ...
                        <div class="form-group mb-3">
                            <span class="fs-5 fw-bolder d-block">Lokasi Alur Pelayaran</span>
                            <div class="ms-3">
                                <label class="" for="">Nama Lokasi Alur Pelayaran</label>
                                <input type="text" class="form-control mb-2 {{ $errors->has('lokasi_alur_pelayaran') ? 'is-invalid' : ''}}"
                                name="lokasi_alur_pelayaran"
                                value="{{old('lokasi_alur_pelayaran')}}">
                                @if ($errors->has('lokasi_alur_pelayaran'))
                                    <div class="invalid-feedback d-block">{{ $errors->first('lokasi_alur_pelayaran') }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <div class="ms-3">
                                <label for="" class="d-block">Kordinat Lokasi Alur Pelayaran </label>
                                <button class="btn btn-sm btn-primary d-block mb-3 btn-rounded" type="button" id="tambahTitikAlurPelayaran">Tambah Titik</button>
                                <div class="list-kordinat-alur-pelayaran d-block">
                        ...
                        {{-- RENCANA KOLAM PUTAR --}}
                        <div class="form-group mb-3">
                            <span class="fs-5 fw-bolder d-block">Koordinat Rencana Kolam Putar</span>
                            <div class="ms-3">
                                <label class="" for="">Nama Lokasi Rencana Kolam Putar</label>
                                <input type="text" class="form-control mb-2 {{ $errors->has('lokasi_rencana_kolam_putar') ? 'is-invalid' : ''}}"
                                name="lokasi_rencana_kolam_putar"
                                value="{{old('lokasi_rencana_kolam_putar')}}">
                                @if ($errors->has('lokasi_rencana_kolam_putar'))
                                    <div class="invalid-feedback d-block">{{ $errors->first('lokasi_rencana_kolam_putar') }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <div class="ms-3">
                                <label for="" class="d-block">Kordinat Lokasi Rencana Kolam Putar </label>
                    ...
                    <div class="col-6">
                        ...
                        {{-- Dokumen Persetujuan  --}}
                        <div class="form-group mb-3">
                            <span class="fs-5 fw-bolder d-block">Dokumen Pertimbangan Penyelenggara Pelabuhan terhadap Kesesuaian Rencana Induk
Pelabuhan (RIP)</span>
                            <div class="ms-3">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span>Permohonan Rekomendasi Teknis Kegiatan Penyelenggaraan Alur Pelayaran telah diajukan kepada Distrik
