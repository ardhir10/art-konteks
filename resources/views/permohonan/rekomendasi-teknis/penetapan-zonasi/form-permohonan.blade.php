...
<div class="row animate__animated  animate__fadeIn">
    <div class="col-lg-12">
        <div class="card shadow-lg">
            ...
            <form id="formPermohonan" action="{{route('permohonan.rekomendasi-teknis.zonasi-perairan.store')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body row">
                    <div class="col-6">
                         {{-- JENIS ZONASI PERAIRAN --}}
                        <div class="form-group mb-2">
                            <span class="fs-5 fw-bolder d-block">Jenis Zonasi Perairan</span>
                            <div class="ms-3">
                                <select name="jenis_zonasi_perairan_id" class="form-select {{ $errors->has('jenis_zonasi_perairan_id') ? 'is-invalid' : ''}}" id="">
                                    <option value="" >--PILIH JENIS ZONASI</option>
                                    @foreach ($data_zonasi_perairan as $item)
                                        <option value="{{$item->id}}" {{old('jenis_zonasi_perairan_id') == $item->id ? 'selected=selected':''}}>{{$item->nama}}</option>
                                    @endforeach
                                </select>
                                @if ($errors->has('jenis_zonasi_perairan_id'))
                                    <div class="invalid-feedback d-block">{{ $errors->first('jenis_zonasi_perairan_id') }}</div>
                                @endif
                            </div>
                        </div>
                        {{-- PERIHAL --}}
                        ...
                        {{-- Kordinat Zonasi Perairan --}}
                        <div class="form-group mb-3">
                            <span class="fs-5 fw-bolder d-block">Kordinat Zonasi Perairan</span>
                            <div class="ms-3">
                                <label class="" for="">Nama Lokasi Zonasi Perairan</label>
                                <input type="text" class="form-control mb-2 {{ $errors->has('lokasi_zonasi_perairan') ? 'is-invalid' : ''}}"
                                name="lokasi_zonasi_perairan"
                                value="{{old('lokasi_zonasi_perairan')}}">
                                @if ($errors->has('lokasi_zonasi_perairan'))
                                    <div class="invalid-feedback d-block">{{ $errors->first('lokasi_zonasi_perairan') }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <div class="ms-3">
                                <label for="" class="d-block">Kordinat Lokasi Zonasi Perairan </label>
                                <button class="btn btn-sm btn-primary d-block mb-3 btn-rounded" type="button" id="tambahTitikZonasiPerairan">Tambah Titik</button>
                                <div class="list-kordinat-zonasi-perairan d-block">
                                        ...
                                        <div class="" style="width: 95%">
                                            <div class="">
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kzp_long_degrees[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="degrees">
                                                            <div class="input-group-text"><span class="fw-bolder" >°</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kzp_long_minutes[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="minutes">
                                                            <div class="input-group-text"><span class="fw-bolder" >'</span></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kzp_long_second[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="second">
                                                            <div class="input-group-text"><span class="fw-bolder" >"</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <select class="form-select" name="kzp_long_direction[]">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kzp_lat_degrees[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="degrees">
                                                            <div class="input-group-text"><span class="fw-bolder" >°</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kzp_lat_minutes[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="minutes">
                                                            <div class="input-group-text"><span class="fw-bolder" >'</span></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kzp_lat_second[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="second">
                                                            <div class="input-group-text"><span class="fw-bolder" >"</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <select class="form-select" name="kzp_lat_direction[]">
                                                            <option value="">DIRECTION</option>
                                                            <option>E</option>
                                                            <option>W</option>
                                                        </select>
                    ...
                    <div class="col-6">
                        ...
                        {{-- PETA LAUT --}}
                        <div class="form-group mb-3">
                            <span class="fs-5 fw-bolder d-block">Peta Laut  (Hasil Survei Hidro-oceanografi berupa peta batimetri yang menunjukkan kondisi
lebar, kedalaman dan dasar laut serta informasi terkait kondisi pasang surut, arah dan
kekuatan arus serta sedimentasi) </span>
                            <div class="ms-3">
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span>Permohonan Rekomendasi Teknis Penetapan Zonasi Perairan telah diajukan kepada Distrik
...
<script>
    ...
    // --- KORDINAT ZONASI PERAIRAN
    $('#tambahTitikZonasiPerairan').on('click',function(){
        var itemKordinat = `
        ...
        $('.list-kordinat-zonasi-perairan').append(itemKordinat);
    });
