...
<div class="row animate__animated  animate__fadeIn">
    <div class="col-lg-12">
        <div class="card shadow-lg">
            ...
            <form id="formPermohonan" action="{{route('permohonan.pertimbangan-teknis.pembangunan-bangunan-perairan.store')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body row">
                    <div class="col-6">
                        {{-- JENIS PEKERJAAN  --}}
                        <div class="form-group mb-2">
                            <span class="fs-5 fw-bolder d-block">Jenis Pekerjaan</span>
                            <div class="ms-3">
                                <select name="jenis_pekerjaan" class="form-select {{ $errors->has('jenis_pekerjaan') ? 'is-invalid' : ''}}" id="">
                                    <option value="" >--PILIH JENIS PEKERJAAN</option>
                                    <option value="Anjungan Lepas Pantai" {{old('jenis_pekerjaan') == 'Anjungan Lepas Pantai' ? 'selected=selected':''}}>Anjungan Lepas Pantai</option>
                                    <option value="Penahan Gelombang" {{old('jenis_pekerjaan') == 'Penahan Gelombang' ? 'selected=selected':''}}>Penahan Gelombang</option>
                                </select>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span>Permohonan Pertimbangan Teknis Kegiatan Pembangunan Bangunan di Perairan telah diajukan kepada Distrik
