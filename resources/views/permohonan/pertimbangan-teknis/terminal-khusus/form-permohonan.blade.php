...
<div class="row animate__animated  animate__fadeIn">
    <div class="col-lg-12">
        <div class="card shadow-lg">
            ...
            <form id="formPermohonan" action="{{route('permohonan.pertimbangan-teknis.terminal-khusus.store')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body row">
                    <div class="col-6">
                        ...
                        <div class="form-group mb-3">
                            <span class="fs-5 fw-bolder d-block">Lokasi Terminal Khusus</span>
                            <div class="ms-3">
                                <label class="" for="">Nama Lokasi Terminal Khusus</label>
                        ...
                        <div class="form-group mb-3">
                            <div class="ms-3">
                                <label for="" class="d-block">Kordinat Lokasi Terminal Khusus </label>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span>Permohonan Pertimbangan Teknis Kegiatan Pembangunan & Pengoperasian Terminal Khusus telah diajukan kepada Distrik
