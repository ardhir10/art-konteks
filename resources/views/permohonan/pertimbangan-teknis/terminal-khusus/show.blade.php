        ...
        <div class="card shadow-lg">
            ...
            <div class="card-body row">
                <div class="col-12">
                    ...
                    <div class="form-group mb-3">
                        <span class="fs-5 fw-bolder d-block mb-2">Lokasi Terminal Khusus</span>
                        <div class="row">
                            <div class="col-4">
                                <span class="text-danger" for="">Nama Lokasi Terminal Khusus</span>
                            ...
                            <div class="col-4">
                                <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#polygonMaps" onclick='showPolygon(@json($data->lokasiTerminalKhusus),"polygonMaps","Lokasi Terminal Khusus")'>LIHAT PETA</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <span class="fs-6 fw-bolder d-block">{{$data->lokasi_rencana_kolam_pelabuhan}}</span>
                            </div>
                            <div class="col-4">
                                <span class="text-danger" for="">Titik Koordinat</span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#polygonMaps" onclick='showPolygon(@json($data->lokasiTerminalKhususRencanaAreaLabuh),"polygonMaps","Lokasi Rencana Area Labuh")'>LIHAT PETA</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <a href="{{asset('/dokumen-permohonan/permohonan-teknis/terminal/rkk/'.$data->rencana_kunjungan_kapal)}}"  target="_blank">
                                            <button class="btn btn-sm btn-success">Download</button>
                                        </a>
                                    </div>
                                </div>
