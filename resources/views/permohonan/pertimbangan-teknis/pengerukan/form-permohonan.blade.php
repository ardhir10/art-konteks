...
<div class="row animate__animated  animate__fadeIn">
    <div class="col-lg-12">
        <div class="card shadow-lg">
            ...
            <form id="formPermohonan" action="{{route('permohonan.pertimbangan-teknis.pengerukan.store')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body row">
                    <div class="col-6">
                        ...
                        <div class="form-group mb-3">
                            <span class="fs-5 fw-bolder d-block">Lokasi Pengerukan</span>
                            <div class="ms-3">
                                <label class="" for="">Nama Lokasi Pengerukan</label>
                                <input type="text" class="form-control mb-2 {{ $errors->has('lokasi_pengerukan') ? 'is-invalid' : ''}}" name="lokasi_pengerukan"  value="{{old('lokasi_pengerukan')}}">
                                @if ($errors->has('lokasi_pengerukan'))
                                    <div class="invalid-feedback d-block">{{ $errors->first('lokasi_pengerukan') }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group mb-3">
                            <div class="ms-3">
                                <label for="" class="d-block">Kordinat Lokasi Pengerukan </label>
                                <button class="btn btn-sm btn-primary d-block mb-3 btn-rounded" type="button" id="tambahTitikPengerukan">Tambah Titik</button>
                                <div class="list-kordinat-pengerukan d-block">
                                        ...
                                        <div class="" style="width: 95%">
                                            <div class="">
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kp_long_degrees[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="degrees">
                                                            <div class="input-group-text"><span class="fw-bolder" >°</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kp_long_minutes[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="minutes">
                                                            <div class="input-group-text"><span class="fw-bolder" >'</span></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kp_long_second[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="second">
                                                            <div class="input-group-text"><span class="fw-bolder" >"</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <select class="form-select" name="kp_long_direction[]">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kp_lat_degrees[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="degrees">
                                                            <div class="input-group-text"><span class="fw-bolder" >°</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kp_lat_minutes[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="minutes">
                                                            <div class="input-group-text"><span class="fw-bolder" >'</span></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="kp_lat_second[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="second">
                                                            <div class="input-group-text"><span class="fw-bolder" >"</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <select class="form-select" name="kp_lat_direction[]">
                                                            <option value="">DIRECTION</option>
                                                            <option>E</option>
                                                            <option>W</option>
                                                        </select>
                        ...
                        {{-- LOKASI DUMPING DI LAUT --}}
                        <div class="form-group mb-2">
                            <span class="fs-5 fw-bolder d-block">Lokasi Dumping di Laut</span>
                            <div class="ms-3">
                                <label class="" for="">Nama Lokasi Dumping di Laut</label>
                                <input type="text" class="form-control mb-2 {{ $errors->has('lokasi_dumping_laut') ? 'is-invalid' : ''}}"
                                    name="lokasi_dumping_laut"
                                    value="{{old('lokasi_dumping_laut')}}">
                                @if ($errors->has('lokasi_dumping_laut'))
                                    <div class="invalid-feedback d-block">{{ $errors->first('lokasi_dumping_laut') }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group mb-2">
                            <div class="ms-3">
                                <label for="" class="d-block">Kordinat Lokasi Dumping di Laut </label>
                                <button class="btn btn-sm btn-primary d-block mb-3 btn-rounded" type="button" id="tambahTitikDumping">Tambah Titik</button>
                                <div class="list-kordinat-dumping d-block">
                                    <div class="item-kordinat shadow-lg d-flex mb-2">
                                        <div class="" style="width: 95%">
                                            <div class="">
                                                <span for="" class="d-block">LONGITUDE </span>
                                                <div class="row mb-2">
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="td_long_degrees[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="degrees">
                                                            <div class="input-group-text"><span class="fw-bolder" >°</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="td_long_minutes[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="minutes">
                                                            <div class="input-group-text"><span class="fw-bolder" >'</span></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="td_long_second[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="second">
                                                            <div class="input-group-text"><span class="fw-bolder" >"</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <select class="form-select" name="td_long_direction[]">
                                                            <option value="">DIRECTION</option>
                                                            <option>N</option>
                                                            <option>S</option>
                                                        </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="td_lat_degrees[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="degrees">
                                                            <div class="input-group-text"><span class="fw-bolder" >°</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="td_lat_minutes[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="minutes">
                                                            <div class="input-group-text"><span class="fw-bolder" >'</span></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="input-group">
                                                            <input type="number" name="td_lat_second[]" class="form-control" id="specificSizeInputGroupUsername" step="0.1"" placeholder="second">
                                                            <div class="input-group-text"><span class="fw-bolder" >"</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <select class="form-select" name="td_lat_direction[]">
                                                            <option value="">DIRECTION</option>
                                                            <option>E</option>
                                                            <option>W</option>
                                                        </select>
                    ...
                    <div class="col-6">
                        ...
                        {{-- Dokumen Persetujuan  --}}
                        <div class="form-group mb-3">
                            <span class="fs-5 fw-bolder d-block">Dokumen Persetujuan Usaha Pertambangan untuk Kegiatan Kerja Keruk dalam Rangka Kegiatan Penambangan</span>
                            <div class="ms-3">
                                <label class="" for="">Nama Instansi Penerbit Dokumen</label>
    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span>Permohonan Pertimbangan Teknis Kegiatan Pengerukan telah diajukan kepada Distrik
                Navigasi Kelas I Tanjung Priok. Harap menunggu tindak lanjut dari Distrik Navigasi Kelas I
                Tanjung Priok pada aplikasi ini.</span>
            </div>
