...
class CreatePermohonanPTPekerjaanBawahAirsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('permohonan_pt_pba', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('permohonan_pt_pba');
    }
}
